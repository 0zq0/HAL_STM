...
int main(void)
{
  ...
  len1=OLED_PrintString(0,0,"Key cnt : ");
  len2=OLED_PrintString(0,2,"Key val : ");
...
//	  OLED_PrintSignedVal(len1,0,key_cnt);
//	  if(0==circle_buf_read(&g_key_bufs,&key_val))
//	  {
//		OLED_ClearLine(len2,2);
//		OLED_PrintHex(len2,2,key_val,1);
//	  }
    /* USER CODE END WHILE */
